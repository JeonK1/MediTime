...
class DBCreater(dbHelper: DBHelper, private val db: SQLiteDatabase){
    ...
    fun createTable(){
        //table1 생성
        var query1 = "CREATE TABLE table1 ( " +
    ...
    fun insertColumn_table1(medi_no:String, medi_name:String, set_cycle:String, start_date:String, re_type:String, re_cycle:String, call_alart:String, normal_alart:String){
        ...
        var query = "INSERT INTO table1 (medi_no, medi_name, set_cycle, start_date, re_type, re_cycle, call_alart, normal_alart) " +
                "VALUES (" + medi_no + ", " + medi_name + ", " + set_cycle + ", " + start_date + ", " + re_type + ", " + re_cycle + ", " + call_alart + ", " + normal_alart +
                " );"
        db.execSQL(query)
    }
    ...
    fun insertColumn_table2(time_no:String, medi_no:String, set_amount:String, set_type:String, set_date:String, take_date:String, set_check:String){
        ...
        var query = "INSERT INTO table1 (time_no, medi_no, set_amount, set_type, set_date, take_date, set_check) " +
                "VALUES (" + time_no + ", " +  medi_no + ", " +  set_amount + ", " +  set_type + ", " +  set_date + ", " +  take_date + ", " +  set_check +
                " );"
        db.execSQL(query)
    }
